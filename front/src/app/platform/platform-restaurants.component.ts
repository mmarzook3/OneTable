              ...
              <tbody>
                @for (tenant of filtered(); track tenant.id) {
                  <tr>
                    ...
                    <td><strong class="plan-name">{{ tenant.saas_plan_code }}</strong><small>{{ tenant.ordering_points_unlimited ? 'Unlimited ordering points' : tenant.table_limit + ' ordering-point allowance' }}</small></td>
